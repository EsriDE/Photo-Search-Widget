    ...
    function (
        ...
        return declare("application.FlickrLayer", [Stateful, Evented], {
            options: {
				...
				imagePath: 'images/map/flickr25x30.png',
                refreshTime: 4000
            },
            constructor: function (options) {
                ...
                this.set("imagePath", defaults.imagePath);
                // listeners
                ...
                // default symbol
                if (!this.symbol) {
                    this.set("symbol", new PictureMarkerSymbol(this.imagePath, 25, 30).setOffset(0, 7));
                }
